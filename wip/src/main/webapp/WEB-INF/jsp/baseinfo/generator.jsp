	...
	<div class="page-header-content">
		<div class="page-title">
			...
			<ul class="breadcrumb breadcrumb-caret position-right">
				...
				<li class="active"><a href="#">발전기 관리</a></li>
			</ul>
		</div>
	</div>
</div>
		...
		<div class="content-wrapper">
			...
			<div class="panel panel-flat border-grey">
				<div class="panel-heading">
					<h5 class="panel-title">발전기 관리</h5>
											...
											<div class="col-md-6">												
												<div class="form-group">
													...
													<div class="input-group">
														...
														<input id="name" name="name" type="text" class="form-control data-field" placeholder="발전기명">
													</div>
												</div>	
											</div>					
											<div class="col-md-6">
...
$(document).ready(function() {
	$("#add_action_btn").on("click", function() {
		...
		case "save":			
			$.ajax({
				url: "${pageContext.request.contextPath}/baseinfo/generator/save",
				type: "POST",
		...
		case "update":
			$.ajax({
				url: "${pageContext.request.contextPath}/baseinfo/generator/update",
				type: "POST",
				data: $( "form" ).serializeArray(),
				success: function(result) {
					$('#add_form_modal').modal('toggle');
    ...
    $("#list").jqGrid({
    	url:"${pageContext.request.contextPath}/baseinfo/generator/jqgrid",    	
		datatype : "json",		
		colNames:['id', '발전기명'],
		colModel:[
	...
	delBtn: function() {
		$("#del_btn").on("click", function() {
			...
			if(selRowIds.length != 0) {
				$.ajax({
					url: "${pageContext.request.contextPath}/baseinfo/generator/delete/" + selRowIds,
					type:"POST",
					success: function() {
						$("#list").trigger("reloadGrid");
					},
